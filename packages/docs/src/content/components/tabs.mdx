...
group: Navigation
order: 16
description: Tabs renders items of value, label, content, icon and disabled in line, pill or soft variants, managing focus, arrow keys, selection and panels across sizes.
---
