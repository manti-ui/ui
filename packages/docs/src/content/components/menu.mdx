...
group: Navigation
order: 33
description: Menu is a floating command list with actions, checkbox and radio items, groups, separators, shortcut hints and nested submenus, driven by items and onSelect.
---
