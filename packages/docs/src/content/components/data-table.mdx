...
group: Data Display
order: 62
description: DataTable is a typed grid built on TanStack table-core, with sortable columns, filtering, pagination, row selection, getRowProps hooks and sizes.
---
