...
group: Data Display
order: 18
description: Carousel renders a slides array with drag, keyboard navigation, snapping, arrows and page indicators, plus slidesPerPage for multi-item pages and loop.
---
