...
group: Inputs
order: 12
description: Switch is an on and off control using role=switch, with defaultChecked or checked plus onCheckedChange, two sizes, and children or inputProps for its label.
---
