...
group: Inputs
order: 22
description: ColorPicker accepts hex, rgba, hsla, hsba and oklch strings and opens an area, channel sliders, format tabs, an eyedropper and an editable copy field.
---
