...
group: Inputs
order: 30
description: Input is a labeled native input wiring helper text, error text, aria-describedby and aria-invalid, with left and right slots, sizes and password controls.
---
