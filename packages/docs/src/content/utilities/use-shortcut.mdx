...
group: Utilities
order: 60
description: useShortcut binds keyboard combinations and multi-key sequences, either globally or scoped to a region, with the platform modifier resolved for you.
---
