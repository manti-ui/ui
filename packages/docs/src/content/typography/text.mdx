...
group: Typography
order: 11
description: Text renders token-backed body copy with a three-step neutral emphasis ladder, semantic color variants, alignment, truncation, and line clamping.
badge: New
---
