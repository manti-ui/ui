...
group: Guides
order: 30
description: 'Restyle Manti UI with ordinary CSS: override component tokens, target the stable data-scope and data-part anatomy, and never fork a component.'
---
