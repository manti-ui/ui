...
/**
 * The Mantı mark, as a single monochrome path so it takes the button's
 * `currentColor` in either theme. Traced from `manti-favicon.svg`; the
 * body-fill path that file pairs it with is dropped, since an icon at this
 * size wants one color, not two.
 */
const MantiMark = (
  <svg
    width="20"
    height="20"
    viewBox="183 158 900 900"
    fill="currentColor"
    fillRule="evenodd"
    aria-hidden="true"
  >
