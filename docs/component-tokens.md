...
| `color-picker`      | `--manti-color-picker-area-height`          | `calc( var(--manti-size-control-height, var(--manti-control-height-md)) * 4 )`              |
...
| `file-upload`       | `--manti-file-upload-gap`                   | `var(--manti-space-3)`                                                                      |
| `file-upload`       | `--manti-file-upload-label-font-size`       | `var(--manti-text-sm)`                                                                      |
| `file-upload`       | `--manti-file-upload-dropzone-gap`          | `var(--manti-space-3)`                                                                      |
| `file-upload`       | `--manti-file-upload-dropzone-padding`      | `var(--manti-space-6)`                                                                      |
| `file-upload`       | `--manti-file-upload-dropzone-radius`       | `var(--manti-radius-md)`                                                                    |
| `file-upload`       | `--manti-file-upload-dropzone-font-size`    | `var(--manti-text-sm)`                                                                      |
| `file-upload`       | `--manti-file-upload-trigger-height`        | `var(--manti-control-height-sm)`                                                            |
| `file-upload`       | `--manti-file-upload-trigger-padding-x`     | `var(--manti-space-4)`                                                                      |
| `file-upload`       | `--manti-file-upload-trigger-radius`        | `var(--manti-radius-sm)`                                                                    |
| `file-upload`       | `--manti-file-upload-trigger-font-size`     | `var(--manti-text-sm)`                                                                      |
| `file-upload`       | `--manti-file-upload-item-gap`              | `var(--manti-space-3)`                                                                      |
| `file-upload`       | `--manti-file-upload-item-group-gap`        | `var(--manti-space-2)`                                                                      |
| `file-upload`       | `--manti-file-upload-item-padding-x`        | `var(--manti-space-3)`                                                                      |
| `file-upload`       | `--manti-file-upload-item-padding-y`        | `var(--manti-space-2)`                                                                      |
| `file-upload`       | `--manti-file-upload-item-radius`           | `var(--manti-radius-sm)`                                                                    |
| `file-upload`       | `--manti-file-upload-item-font-size`        | `var(--manti-text-sm)`                                                                      |
| `file-upload`       | `--manti-file-upload-item-size-font-size`   | `var(--manti-text-xs)`                                                                      |
| `file-upload`       | `--manti-file-upload-delete-trigger-size`   | `var(--manti-space-6)`                                                                      |
| `file-upload`       | `--manti-file-upload-delete-trigger-radius` | `var(--manti-radius-sm)`                                                                    |
...
| `menu`              | `--manti-menu-item-radius`                  | `var( --manti-size-item-radius, var(--manti-radius-md) )`                                   |
...
| `number-input`      | `--manti-number-input-radius`               | `max( var(--manti-size-control-radius, var(--manti-radius-md)), var(--manti-radius-pill) )` |
...
| `radio-group`       | `--manti-radio-group-gap`                   | `var(--manti-space-3)`                                                                      |
| `radio-group`       | `--manti-radio-group-horizontal-gap`        | `var(--manti-space-5)`                                                                      |
| `radio-group`       | `--manti-radio-group-item-gap`              | `var(--manti-space-3)`                                                                      |
| `radio-group`       | `--manti-radio-group-control-size`          | `var(--manti-text-xl)`                                                                      |
| `radio-group`       | `--manti-radio-group-dot-size`              | `var(--manti-space-2)`                                                                      |
| `radio-group`       | `--manti-radio-group-label-font-size`       | `var(--manti-text-sm)`                                                                      |
| `radio-group`       | `--manti-radio-group-item-font-size`        | `var(--manti-text-sm)`                                                                      |
...
| `segmented-control` | `--manti-segmented-control-radius`          | `var( --manti-size-control-radius, var(--manti-radius-md) )`                                |
...
| `tabs`              | `--manti-tabs-gap`                          | `var(--manti-space-4)`                                                                      |
| `tabs`              | `--manti-tabs-list-gap`                     | `var(--manti-space-1)`                                                                      |
| `tabs`              | `--manti-tabs-track-padding`                | `var(--manti-space-1)`                                                                      |
| `tabs`              | `--manti-tabs-track-radius`                 | `var(--manti-radius-full)`                                                                  |
| `tabs`              | `--manti-tabs-track-radius-vertical`        | `var(--manti-radius-xl)`                                                                    |
| `tabs`              | `--manti-tabs-trigger-gap`                  | `var(--manti-space-2)`                                                                      |
| `tabs`              | `--manti-tabs-trigger-padding-y`            | `calc(var(--manti-space-1) * 1.5)`                                                          |
| `tabs`              | `--manti-tabs-trigger-padding-x`            | `var(--manti-space-4)`                                                                      |
| `tabs`              | `--manti-tabs-trigger-font-size`            | `var( --manti-size-text, var(--manti-text-base) )`                                          |
| `tabs`              | `--manti-tabs-trigger-radius`               | `var( --manti-size-control-radius, var(--manti-radius-md) )`                                |
| `tabs`              | `--manti-tabs-indicator-size`               | `calc(var(--manti-space-1) / 2)`                                                            |
| `tabs`              | `--manti-tabs-content-radius`               | `var(--manti-radius-sm)`                                                                    |
...
| `toggle-group`      | `--manti-toggle-group-radius`               | `var( --manti-size-control-radius, var(--manti-radius-md) )`                                |
...
| `tree-view`         | `--manti-tree-view-gap`                     | `var(--manti-space-2)`                                                                      |
| `tree-view`         | `--manti-tree-view-tree-gap`                | `calc(var(--manti-space-1) / 2)`                                                            |
| `tree-view`         | `--manti-tree-view-label-font-size`         | `var(--manti-text-sm)`                                                                      |
| `tree-view`         | `--manti-tree-view-item-gap`                | `var(--manti-space-2)`                                                                      |
| `tree-view`         | `--manti-tree-view-item-padding-y`          | `var(--manti-space-1)`                                                                      |
| `tree-view`         | `--manti-tree-view-item-padding-x`          | `var(--manti-space-3)`                                                                      |
| `tree-view`         | `--manti-tree-view-item-radius`             | `var(--manti-radius-sm)`                                                                    |
| `tree-view`         | `--manti-tree-view-item-font-size`          | `var(--manti-text-sm)`                                                                      |
| `tree-view`         | `--manti-tree-view-branch-indent`           | `var(--manti-space-4)`                                                                      |
| `tree-view`         | `--manti-tree-view-leaf-indent`             | `calc( var(--manti-space-3) + var(--manti-space-5) )`                                       |
